...
if($lastInsertId)
{
$msg="Projector type added Successfully";
}
else 
{
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Add Projector Type</title>
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Add projector Type</div>
                    </div>
...
<input id="leavetype" type="text"  class="validate" autocomplete="off" name="leavetype"  required>
                                                <label for="leavetype">Projector Type</label>
                                            </div>
