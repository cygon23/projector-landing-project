...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin_support | Returned Projector </title>
    ...
    <body>
       ...
       <?php include('includes/sidebarsupport.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Returned Projector History</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Returned Projector History</span>
...
if($stats==1){
                                             ?>
                                                ...
                                                <span style="color: red">Not Returned</span>
                                                 <?php } if($stats==0)  { ?>
 <span style="color: blue">waiting for Returned</span>
 <?php } ?>
