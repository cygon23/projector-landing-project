...
$status=$_POST['status'];   
date_default_timezone_set('TANZANIA/ARUSHA');
$admremarkdate=date('Y-m-d G:i:s ', strtotime("now"));
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | applying Details </title>
    ...
    <body>
       ...
       <?php include('includes/sidebarsupport.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="font-size:24px;">Applying Details</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Applying Details</span>
...
{         
  ...
  <tr>
                                             <td style="font-size:16px;"><b>Projector Type :</b></td>
                                            <td><?php echo htmlentities($result->LeaveType);?></td>
                                             <td style="font-size:16px;"><b>applying Date:</b></td>
...
<tr>
                                             <td style="font-size:16px;"><b>Employe applying Description : </b></td>
                                            <td colspan="5"><?php echo htmlentities($result->Description);?></td>
                                          
                                        </tr>

<tr>
<td style="font-size:16px;"><b>Applying Status :</b></td>
