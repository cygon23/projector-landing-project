...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Support_Admin | Not returned projector </title>
    ...
    <body>
       ...
       <?php include('includes/sidebarsupport.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"> Not returned projector History</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Not returned projector History</span>
