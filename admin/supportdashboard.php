...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="support,dashboard" />
    ...
    <body>
           <?php include('includes/headersupoort.php');?>
            
       <?php include('includes/sidebarsupport.php');?>
...
?>                            
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title">Listed Projector Type</span>
                                    <?php
...
?>   
     ...
     <a href="approvedleave-history.php" target="blank">
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title">returned projector</span>
                                    <?php
...
?>   
     ...
     <a href="pending-projectorhistory.php" target="blank">
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title">New projector Applications</span>
                                    <?php
                        ...
                        <div class="col s15 m12 l12">
                            <div class="card invoices-card">
                                <div class="card-content">
                                    ...
                                    <span class="card-title">projector Applications</span>
                             <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th width="200">Employe Name</th>
                                            <th width="120">projector Type</th>
...
if($stats==1){
                                             ?>
                                                ...
                                                <span style="color: red">Not Returned</span>
                                                 <?php } if($stats==0)  { ?>
 <span style="color: blue">waiting for return</span>
 <?php } ?>
          ...
          <td>
           <td><a href="leaves_detail_support.php?leaveid=<?php echo htmlentities($result->lid);?>" class="waves-effect waves-light btn blue m-b-xs"  > View Details</a></td>
                                    </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
