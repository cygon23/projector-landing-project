...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Employe | Apply Projector</title>
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Apply for Projector</div>
                    </div>
...
<div class="input-field col s12">
    ...
    if ($query->rowCount() > 0) {
        echo '<select name="leavetype" autocomplete="off">';
        echo '<option value="">Select Projector type</option>';
        foreach ($results as $result) {
            echo '<option value="'.htmlentities($result->LeaveType).'">'.htmlentities($result->LeaveType).'</option>';
        }
        echo '</select>';
    } else {
        echo 'Oops!! No projectors available.';
    }
    ?>
</div>
